...
Deploy app team B qua GitOps. Manifest dùng lại image `ghcr.io/minhkhoa2209/w10-api:0.0.1`, đặt `VERSION=payments-v0.0.1`, chạy non-root và có đủ CPU/memory requests + limits để pass Gatekeeper.
